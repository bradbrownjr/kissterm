# CHANGELOG archive — kissterm

Entries from 2026-09-21 and earlier, moved out of `docs/CHANGELOG.md` on
2026-09-23 so the live changelog stays short enough to read. Newest at top.
...
- **Passive known-nodes picker.** Valid `PID_NETROM` routing broadcasts are
  ...
  **Files:** `kissterm/netrom.py`, `kissterm/ui/app.py`,
  ...
  `tests/pilot/test_netrom_known_nodes.py`, `docs/ROADMAP.md`,
  `docs/CHANGELOG.md`.
