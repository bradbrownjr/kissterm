...
own color-scheme file, needs nowhere else to go. It is also editable field-
by-field from the Appearance tab in Settings, one hex-input widget per
`CUSTOM_THEME_FIELDS` entry plus a swatch preview -- `config.toml` remains
the other way in, for a value copied by hand or generated by an external
tool.
"""
...
THEME_CATALOG: tuple[ThemeFamily, ...] = (
    ...
    ThemeFamily(
        ...
        note="Exact hex values, editable from the Appearance tab in "
